...
function sidebarColor(e) {
    ...
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active"),
        ...
        document.querySelector("#sidenavCard") &&
            ((t = ["card", "card-background", "shadow-none", "card-background-mask-" + n]),
...
function sidebarType(e) {
    for (
        var t = e.parentElement.children, a = e.getAttribute("data-class"), n = document.querySelector("body"), i = document.querySelector("body:not(.dark-version)"), n = n.classList.contains("dark-version"), l = [], s = 0;
        s < t.length;
        s++
    )
        t[s].classList.remove("active"), l.push(t[s].getAttribute("data-class"));
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active");
    for (var r, o, d, c = document.querySelector(".sidenav"), s = 0; s < l.length; s++) c.classList.remove(l[s]);
    ...
    ("bg-transparent" != a && "bg-white" != a) || !i
        ? (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct-dark.png") && ((d = o.replace("logo-ct-dark", "logo-ct")), (r.src = d))
        : (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && ((d = o.replace("logo-ct", "logo-ct-dark")), (r.src = d)),
        "bg-white" == a && n && (o = (r = document.querySelector(".navbar-brand-img")).src).includes("logo-ct.png") && ((d = o.replace("logo-ct", "logo-ct-dark")), (r.src = d));
}
function navbarFixed(e) {
    ...
    e.getAttribute("checked")
        ? (a.classList.remove(...t), a.setAttribute("data-scroll", "false"), navbarBlurOnScroll("navbarBlur"), e.removeAttribute("checked"))
        : (a.classList.add(...t), a.setAttribute("data-scroll", "true"), navbarBlurOnScroll("navbarBlur"), e.setAttribute("checked", "true"));
}
...
function toggleSidenav() {
    body.classList.contains(className)
        ...
        : (body.classList.add(className), sidenav.classList.remove("bg-transparent"), iconSidenav.classList.remove("d-none"));
}
    ...
    sidenav &&
        (1200 < window.innerWidth
            ? referenceButtons.classList.contains("active") && "bg-transparent" === referenceButtons.getAttribute("data-class")
                ? sidenav.classList.remove("bg-white")
                : document.querySelector("body").classList.contains("dark-version") || sidenav.classList.add("bg-white")
            : sidenav.classList.remove("bg-transparent"));
}
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        for (x = 0; x < a.length; x++) a[x].classList.contains("light") && (a[x].classList.add("dark"), a[x].classList.remove("light"));
        for (x = 0; x < n.length; x++) n[x].classList.contains("light") && (n[x].classList.add("dark"), n[x].classList.remove("light"));
        for (x = 0; x < b.length; x++) b[x].classList.add("blur", "shadow-blur");
        for (x = 0; x < i.length; x++) i[x].classList.contains("text-white") && (i[x].classList.remove("text-white"), i[x].classList.add("text-dark"));
        for (x = 0; x < s.length; x++) !s[x].classList.contains("text-white") || s[x].closest(".sidenav") || s[x].closest(".card.bg-gradient-dark") || (s[x].classList.remove("text-white"), s[x].classList.add("text-dark"));
        for (x = 0; x < o.length; x++) o[x].classList.contains("text-white") && (o[x].classList.remove("text-white"), o[x].classList.add("text-dark"));
        for (x = 0; x < c.length; x++) c[x].classList.contains("text-white") && !c[x].closest(".sidenav") && (c[x].classList.remove("text-white"), c[x].classList.add("text-dark"));
        for (x = 0; x < u.length; x++) u[x].classList.contains("text-white") && (u[x].classList.remove("text-white"), u[x].classList.remove("opacity-8"), u[x].classList.add("text-dark"));
        for (x = 0; x < g.length; x++) g[x].classList.contains("bg-gray-600") && (g[x].classList.remove("bg-gray-600"), g[x].classList.add("bg-gray-100"));
        for (x = 0; x < p.length; x++) p[x].hasAttribute("fill") && p[x].setAttribute("fill", "#252f40");
        for (x = 0; x < v.length; x++) v[x].closest(".card.bg-gradient-dark") || (v[x].classList.remove("text-white"), v[x].classList.add("text-dark"));
        for (x = 0; x < y.length; x++) y[x].classList.remove("border-dark");
        e.removeAttribute("checked");
    } else {
        t.classList.add("dark-version");
        for (var x = 0; x < a.length; x++) a[x].classList.contains("dark") && (a[x].classList.remove("dark"), a[x].classList.add("light"));
        for (var x = 0; x < b.length; x++) b[x].classList.contains("blur") && b[x].classList.remove("blur", "shadow-blur");
        for (var x = 0; x < n.length; x++) n[x].classList.contains("dark") && (n[x].classList.remove("dark"), n[x].classList.add("light"));
        for (var x = 0; x < i.length; x++) i[x].classList.contains("text-dark") && (i[x].classList.remove("text-dark"), i[x].classList.add("text-white"));
        for (var x = 0; x < l.length; x++) l[x].classList.contains("text-dark") && (l[x].classList.remove("text-dark"), l[x].classList.add("text-white"));
        for (var x = 0; x < r.length; x++) r[x].classList.contains("text-dark") && (r[x].classList.remove("text-dark"), r[x].classList.add("text-white"));
        for (var x = 0; x < d.length; x++) d[x].classList.contains("text-dark") && (d[x].classList.remove("text-dark"), d[x].classList.add("text-white"));
        for (var x = 0; x < u.length; x++) u[x].classList.contains("text-secondary") && (u[x].classList.remove("text-secondary"), u[x].classList.add("text-white"), u[x].classList.add("opacity-8"));
        for (var x = 0; x < m.length; x++) m[x].classList.contains("bg-gray-100") && (m[x].classList.remove("bg-gray-100"), m[x].classList.add("bg-gray-600"));
        for (var x = 0; x < f.length; x++) f[x].classList.remove("text-dark"), f[x].classList.add("text-white");
        for (var x = 0; x < p.length; x++) p[x].hasAttribute("fill") && p[x].setAttribute("fill", "#fff");
...
var material = {
    ...
    showSwal: function (e) {
        if ("basic" == e) {
            const t = Swal.mixin({ customClass: { confirmButton: "btn bg-gradient-info" } });
            t.fire({ title: "Sweet!" });
        } else if ("title-and-text" == e) {
            const a = Swal.mixin({ customClass: { confirmButton: "btn bg-gradient-success", cancelButton: "btn bg-gradient-danger" } });
            a.fire({ title: "Sweet!", text: "Modal with a custom image.", imageUrl: "https://unsplash.it/400/200", imageWidth: 400, imageAlt: "Custom image" });
            ...
            i.fire({ title: "Are you sure?", text: "You won't be able to revert this!", icon: "warning", showCancelButton: !0, confirmButtonText: "Yes, delete it!" }).then((e) => {
            ...
            s.fire({ title: "هل تريد الاستمرار؟", icon: "question", iconHtml: "؟", confirmButtonText: "نعم", cancelButtonText: "لا", showCancelButton: !0, showCloseButton: !0 });
            ...
            const r = Swal.mixin({ customClass: { confirmButton: "btn bg-gradient-success", cancelButton: "btn bg-gradient-danger" }, buttonsStyling: !1 });
            r.fire({
